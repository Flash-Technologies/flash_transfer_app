...
class MobilePaymentDetails extends StatefulWidget {
  ...
  @override
  State<MobilePaymentDetails> createState() => _MobilePaymentDetailsState();
}

class _MobilePaymentDetailsState extends State<MobilePaymentDetails> with SingleTickerProviderStateMixin {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (widget.details.phoneNumber != null)
            _buildDetailRow(
              label: "Phone Number",
              value: widget.details.phoneNumber!,
            ),
