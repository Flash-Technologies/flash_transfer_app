...
class _WalletSelectorSheetState extends State<WalletSelectorSheet> {
  final List<WalletApp> _wallets = [
    WalletApp(
      ...
      scheme: 'metamask://',
      storeUrlAndroid: 'https://play.google.com/store/apps/details?id=io.metamask',
    ...
    WalletApp(
      ...
      scheme: 'trust://',
      storeUrlAndroid: 'https://play.google.com/store/apps/details?id=com.wallet.crypto.trustapp',
      storeUrlIOS: 'https://apps.apple.com/app/trust-crypto-bitcoin-wallet/id1288339409',
    ...
    WalletApp(
      ...
      scheme: 'phantom://',
      storeUrlAndroid: 'https://play.google.com/store/apps/details?id=app.phantom',
      storeUrlIOS: 'https://apps.apple.com/app/phantom-crypto-wallet/id1598432977',
    ...
    WalletApp(
      ...
      scheme: 'cbwallet://',
      storeUrlAndroid: 'https://play.google.com/store/apps/details?id=org.toshi',
    ...
    WalletApp(
      ...
      scheme: 'bnc://',
      storeUrlAndroid: 'https://play.google.com/store/apps/details?id=com.binance.dev',
      storeUrlIOS: 'https://apps.apple.com/app/binance-buy-bitcoin-crypto/id1436799971',
    ...
    WalletApp(
      ...
      scheme: 'rainbow://',
      storeUrlAndroid: 'https://play.google.com/store/apps/details?id=me.rainbow',
      storeUrlIOS: 'https://apps.apple.com/app/rainbow-ethereum-wallet/id1457119021',
    ...
    WalletApp(
      ...
      scheme: 'zengo://',
      storeUrlAndroid: 'https://play.google.com/store/apps/details?id=com.zengo.wallet',
      storeUrlIOS: 'https://apps.apple.com/app/zengo-crypto-bitcoin-wallet/id1440147115',
    ...
    WalletApp(
      ...
      scheme: 'awallet://',
      storeUrlAndroid: 'https://play.google.com/store/apps/details?id=io.alphawallet.android',
      storeUrlIOS: 'https://apps.apple.com/app/alphawallet-ethereum-wallet/id1358230430',
    ...
    WalletApp(
      ...
      scheme: 'argent://',
      storeUrlAndroid: 'https://play.google.com/store/apps/details?id=im.argent.contractwalletclient',
    ...
    WalletApp(
      ...
      scheme: 'imtokenv2://',
      storeUrlAndroid: 'https://play.google.com/store/apps/details?id=im.token.app',
      storeUrlIOS: 'https://apps.apple.com/app/imtoken-2-0-bitcoin-ethereum/id1384798940',
  ...
  Future<bool> _isWalletInstalled(WalletApp wallet) async {
    try {
      if (Platform.isAndroid) {
        // Try to check if app exists on Android using the scheme
