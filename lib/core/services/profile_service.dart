...
//       } else {
//         throw Exception('Failed to load preferences: ${response.statusMessage}');
//       }
...
//     try {
//       final response = await _apiClient.put('/user/preferences', data: {
//         key: value,
//       });

//       if (response.statusCode != 200) {
//         throw Exception('Failed to update preference: ${response.statusMessage}');
//       }
//     } on DioException catch (e) {
...
//   }) async {
//     try {
//       final response = await _apiClient.put('/user/password', data: {
...
//     try {
//       final response = await _apiClient.post('/user/2fa/toggle', data: {
//         'enabled': enable,
//       });
...
//     try {
//       final response = await _apiClient.delete('/user/account', data: {
//         'password': password,
//       });
...
//       } else {
//         throw Exception('Failed to load notification settings: ${response.statusMessage}');
//       }
//     } on DioException catch (e) {
//       throw Exception('Network error loading notification settings: ${e.message}');
//     } catch (error) {
...
//     try {
//       final response = await _apiClient.put('/user/notification-settings', data: settings);

//       if (response.statusCode != 200) {
//         throw Exception('Failed to update notification settings: ${response.statusMessage}');
//       }
//     } on DioException catch (e) {
//       throw Exception('Network error updating notification settings: ${e.message}');
//     } catch (error) {
...
//         return response.data as Map<String, dynamic>;
//       } else {
//         throw Exception('Failed to load privacy settings: ${response.statusMessage}');
//       }
//     } on DioException catch (e) {
...
//     try {
//       final response = await _apiClient.put('/user/privacy-settings', data: settings);

//       if (response.statusCode != 200) {
//         throw Exception('Failed to update privacy settings: ${response.statusMessage}');
//       }
//     } on DioException catch (e) {
